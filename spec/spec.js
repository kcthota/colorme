describe("ColorTests", function() {
    ...
    it("Hex to RGB - random color", function() {
        ...
        expect(rgb.g).toBe(52);
        expect(rgb.b).toBe(86);
    });
    ...
    it("Hex to HSL - random color", function() {
        ...
        expect(parseFloat(hsl.s.toFixed(2))).toBe(0.65);
        expect(parseFloat(hsl.l.toFixed(2))).toBe(0.20);
    });
    ...
    it("Hex to HSL - black", function() {
        ...
        hsl = hexColor.getHSL();
        expect(hsl.h).toBe(0);
        expect(parseFloat(hsl.s.toFixed(2))).toBe(0.00);
        expect(parseFloat(hsl.l.toFixed(2))).toBe(0.00);
    });
    ...
    it("Hex to HSL - white", function() {
        ...
        expect(hsl.h).toBe(0);
        expect(parseFloat(hsl.s.toFixed(2))).toBe(0.00);
        expect(parseFloat(hsl.l.toFixed(2))).toBe(1.00);
    });
    ...
    it("RGB to HSL - random color", function() {
        ...
        hsl = rgb.getHSL();
        expect(hsl.h).toBe(149);
        expect(parseFloat(hsl.s.toFixed(2))).toBe(0.90);
        expect(parseFloat(hsl.l.toFixed(2))).toBe(0.48);
    });
    ...
    it("create HSL - s and l positive boundary tests", function() {
        ...
        expect(hsl.h).toBe(0);
        expect(parseFloat(hsl.s.toFixed(2))).toBe(1.00);
        expect(parseFloat(hsl.l.toFixed(2))).toBe(1.00);
    });
    ...
    it("HSL to RGB - random color", function() {
        ...
        rgb = hsl.getRGB();
        expect(rgb.r).toBe(197);
        expect(rgb.g).toBe(194);
    ...
    it("HSL to RGB - grey", function() {
        ...
        rgb = hsl.getRGB();
        expect(rgb.r).toBe(51);
        expect(rgb.g).toBe(51);
